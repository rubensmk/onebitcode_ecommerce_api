  ...
  context "when #call" do
    ...
    context "with search filter" do
      ...
      it "does not return unenexpected records" do
        ...
        service = described_class.new(params)
        service.call
        expect(service.records).not_to include(*general_products)
      end
    ...
    context "with price filter" do
      ...
      context "only :min fulfilled" do
        ...
        it "does not return unenexpected records" do
          ...
          service = described_class.new(params)
          service.call
          expect(service.records).not_to include(*lower_prices_products)
        end
      ...
      context "only :max fulfilled" do
        ...
        it "does not return unenexpected records" do
          ...
          service = described_class.new(params)
          service.call
          expect(service.records).not_to include(*(higher_price_products + general_products))
        end
    ...
    context "with release date filter" do
      ...
      context "only :min fulfilled" do
        ...
        it "does not return unenexpected records" do
          ...
          service = described_class.new(params)
          service.call
          expect(service.records).not_to include(*(older_products + general_products))
        end
      ...
      context "only :max fulfilled" do
        ...
        it "does not return unenexpected records" do
          ...
          service = described_class.new(params)
          service.call
          expect(service.records).not_to include(*recently_released_products)
        end
