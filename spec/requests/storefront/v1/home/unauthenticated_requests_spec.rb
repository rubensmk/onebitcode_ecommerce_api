  ...
  context "GET /home" do
    ...
    context "on :featured" do
      ...
      it "does not returns any non-featured products" do
        ...
        expect(body_json["featured"]).not_to include(*unexpected_products)
      end
    end
    ...
    context "on :last_releases" do
      ...
      it "does not returns any non-last released products" do
        ...
        expect(body_json["last_releases"]).not_to include(*unexpected_products)
      end
    end
    ...
    context "on :cheapest" do
      ...
      it "does not returns any non-last released products" do
        ...
        expect(body_json["cheapest"]).not_to include(*unexpected_products)
      end
    end
  end
